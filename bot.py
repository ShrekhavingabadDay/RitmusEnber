...
bot=commands.Bot(command_prefix=get_prefix,description='Zenedörgetős diszkordbot jó terpesztéssel')

exts=['music'] #Add your Cog extensions here

@bot.event
async def on_ready():
    song_name='Brushy One String - Chicken in the Corn'  #Status name
